...
- **Dry run on a test user's OS** with no prompt. Expected: skill surfaces 2-3 candidates pulled from their recent activity, priorities, and top_pain. Generic output ("you should build a brief") = fail.
